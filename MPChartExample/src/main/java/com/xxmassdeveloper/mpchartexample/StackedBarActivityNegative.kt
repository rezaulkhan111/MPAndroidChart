...
class StackedBarActivityNegative : DemoBase(), OnChartValueSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        values.add(BarEntry(5, floatArrayOf(-10f, 10f)))
        values.add(BarEntry(15, floatArrayOf(-12f, 13f)))
        values.add(BarEntry(25, floatArrayOf(-15f, 15f)))
        values.add(BarEntry(35, floatArrayOf(-17f, 17f)))
        values.add(BarEntry(45, floatArrayOf(-19f, 20f)))
        values.add(BarEntry(45, floatArrayOf(-19f, 20f), resources.getDrawable(R.drawable.star)))
        values.add(BarEntry(55, floatArrayOf(-19f, 19f)))
        values.add(BarEntry(65, floatArrayOf(-16f, 16f)))
        values.add(BarEntry(75, floatArrayOf(-13f, 14f)))
        values.add(BarEntry(85, floatArrayOf(-10f, 11f)))
        values.add(BarEntry(95, floatArrayOf(-5f, 6f)))
        values.add(BarEntry(105, floatArrayOf(-1f, 2f)))
